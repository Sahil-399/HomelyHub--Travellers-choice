          ...
          <div className="col-10 col-lg-5">
            <form onSubmit={submitHandler}>
              ...
              <div className="form-group">
                ...
                <input type='password' id="password_field" className="form-control" value={password} onChange={(e)=>setPassoword(e.target.value)} />
              </div>
              <Link to="/user/forgot/password" className="float-right mb-4">Forgot Password?</Link>
